...
namespace EVA
{
	...
	public:
		 ...
		 * \return The ray
		 */
		static Ray ScreenPosToWorldRay(glm::ivec2 mousePos, const Camera* camera);
		 ...
		 */
		static bool TestRayObbIntersection(Ray ray, glm::vec3 aabbMin, glm::vec3 aabbMax, glm::mat4 modelMatrix,
